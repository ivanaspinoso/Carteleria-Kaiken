...
export default function PlacaKiloKaiken({
  ...
  return (
    <PlacaVideo src="/placas/kilo-kaiken.mp4" activo={activo}>
      ...
      {precio ? (
        <OverlayTexto topPct={36.8} fontPx={38} weight={450} color={COLORS.violeta} style={{ left: "62%", width: "auto", whiteSpace: "nowrap" }}>
          {precio}
        </OverlayTexto>
      ) : null}
      ...
      {gustos ? (
        <OverlayTexto topPct={81.5} fontPx={16} weight={400} color={COLORS.blancoSobreFondo} style={{ left: "50%", width: "46%", lineHeight: 1.4 }}>
          {gustos}
        </OverlayTexto>
      ) : null}
    </PlacaVideo>
