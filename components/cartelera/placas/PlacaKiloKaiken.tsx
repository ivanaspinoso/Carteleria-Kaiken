...
export default function PlacaKiloKaiken({
  ...
  return (
    <PlacaVideo src="/placas/kilo-kaiken.mp4" activo={activo}>
      ...
      {precio ? (
        <OverlayTexto topPct={36.5} fontPx={28} weight={400} color={COLORS.violeta} style={{ left: "64%", width: "auto", whiteSpace: "nowrap" }}>
          {precio}
        </OverlayTexto>
      ) : null}
      ...
      {gustos ? (
        <OverlayTexto topPct={82} fontPx={10} weight={400} color={COLORS.blancoSobreFondo} style={{ left: "50%", width: "46%", lineHeight: 1.4 }}>
          {gustos}
        </OverlayTexto>
      ) : null}
    </PlacaVideo>
